...
import com.simontuffs.onejar.args.test.Main;
import com.simontuffs.onejar.test.Invoker;

public class SelfTestOneJarArgsSuite {

    protected static Object test;
    protected static int failures = 0;
    
    public static final String MAIN_CLASS = "com.simontuffs.onejar.args.test.Main";

    public static void main(String args[]) {
        new TestSuite(SelfTestOneJarArgsSuite.class).run(new TestResult());
    }
