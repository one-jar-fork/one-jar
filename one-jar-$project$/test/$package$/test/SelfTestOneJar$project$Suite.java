...
public class SelfTestOneJar$project$Suite {

    protected static Object test;
    protected static int failures = 0;
    
    public static final String MAIN_CLASS = "$package$.test.Main";

    public static void main(String args[]) {
        new TestSuite(SelfTestOneJar$project$Suite.class).run(new TestResult());
    }
