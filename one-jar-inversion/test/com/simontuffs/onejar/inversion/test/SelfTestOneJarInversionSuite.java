...
public class SelfTestOneJarInversionSuite {

    protected static Object test;
    protected static int failures = 0;
    
    public static final String MAIN_CLASS = "com.simontuffs.onejar.inversion.test.Main";

    public static void main(String args[]) {
        new TestSuite(SelfTestOneJarInversionSuite.class).run(new TestResult());
    }
