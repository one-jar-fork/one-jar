...
import com.simontuffs.onejar.test.jdbc.main.Main;

public class SelfTestOneJarJdbcSuite {

    protected static Object test;
    protected static int failures = 0;
    
    public static final String MAIN_CLASS = "com.simontuffs.onejar.test.jdbc.main.Main";

    public static void main(String args[]) {
        new TestSuite(SelfTestOneJarJdbcSuite.class).run(new TestResult());
    }
